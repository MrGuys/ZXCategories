...
- (NSData *)zx_hmacMD5DataWithKey:(NSData *)key {
    return [self zx_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
/**
 *  @brief  sha1Data NSData
 *
...
{
    return [self zx_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}
/**
 *  @brief  sha256Data NSData
 *
...
{
    return [self zx_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
/**
 *  @brief  sha512Data NSData
 *
...
{
    return [self zx_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}


- (NSData *)zx_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
