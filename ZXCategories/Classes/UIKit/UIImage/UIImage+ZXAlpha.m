...
@implementation UIImage (ZXAlpha)
/**
 *  @brief  是否有alpha通道
 *
 *  @return 是否有alpha通道
...
- (UIImage *)zx_transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self zx_newBorderMask:borderSize size:newRect.size];
...
- (CGImageRef)zx_newBorderMask:(NSUInteger)borderSize size:(CGSize)size {
